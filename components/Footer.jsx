    ...
    <div className="container mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="mt-4 space-x-2">
          <Image className='w-10 h-10 mb-4' src={footerLogo} alt="Company Logo" width={50} height={50} />
          <p className="text-sm">
            Non-Profit Inc.<br/>
        ...
        <div className="mt-4 space-x-2">
          ...
          <a className="link link-hover">Use Cases</a> 
      ...
      <div className="border-t border-base-300 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex mt-4 md:mt-0">
          <a className="link link-hover text-sm mr-4">Privacy Policy</a>
          <a className="link link-hover text-sm mr-4">Terms of Service</a>
          <a className="link link-hover text-sm">Cookie Settings</a>
        </div>
      </div>
    </div>
  </footer>
